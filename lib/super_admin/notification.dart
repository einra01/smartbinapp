              ...
              actions: [
                ElevatedButton(
                  onPressed: () {
                    ...
                    _fetchNotifications(); // ✅ Fetch notifications after applying the new date range
      ...
      children: [
        ...
        Container(
          padding: EdgeInsets.only(
            top: MediaQuery.of(context).size.height * 0.005, // 🔥 Adjusts based on screen height
            bottom: 10,
            left: 16,
            right: 16,
          ),
          child: Stack(
            ...
            children: [
              ...
              Positioned(
                right: 0,
                top: MediaQuery.of(context).size.height * -0.005, // 🔥 Moves icon up responsively
                bottom: 0,
                child: IconButton(
        ...
        // 🔥 Fetch notifications with date range filter
        Expanded(
          child: FutureBuilder<List<MapEntry<String, dynamic>>>(
            future: _fetchNotifications(), // ✅ Fetch notifications dynamically
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: notifications.map((entry) {
                    ...
                    final date = data['date'] ?? 'Unknown date'; // ✅ Fix: No $
                  ...
                  }).toList(), // ✅ Ensure toList() is added for proper mapping
