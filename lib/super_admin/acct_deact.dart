    ...
    return Scaffold(
      ...
      body:Stack(
        children: [
          ...
          Positioned.fill(
            child: Container(
              color: Colors.grey[200], // ✅ Grey Background Restored
            ),
          ),

          // 🔹 ACCOUNT DEACTIVATION Header (Fixed)
          Positioned(
            top: 80,
            left: 0,
            right: 0,
          ...
          Positioned(
            top: MediaQuery.of(context).size.height * 0.162, // Adjust percentage as needed
            left: 0,
            right: 0,
            child: Padding(
          ...
          // 🔹 Scrollable User List (NO Overlap)
          Positioned(
            top: 250, // ✅ Lowered list start point to avoid overlapping header
            left: 0,
            right: 0,
            bottom: 0,
            child: Container(
              color: Colors.grey[200], // ✅ Ensures background stays grey
              child: ListView.builder(
                physics: const AlwaysScrollableScrollPhysics(),
                padding: EdgeInsets.only(top: 5), // ✅ Adds small gap to prevent overlap
                itemCount: filteredUsers.length,
                itemBuilder: (context, index) {
                  final user = filteredUsers[index];

                  // Determine the action image path based on the user's status
                  ...
                  return _buildUserRow(
                    ...
                    user.status,
                    actionImagePath,
                    backgroundColor: Colors.white, // ✅ Grey Background
                    onActionTap: () {
