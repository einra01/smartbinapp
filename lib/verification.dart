...
class _ConfirmationScreenState extends State<ConfirmationScreen> {
  ...
  Future<void> _verifyOTP() async {
    ...
    if (enteredOtp == widget.otp) {
      final databaseRef = FirebaseDatabase.instance.ref('users'); // Pointing directly to 'users'
      final user = widget.users;

      try {
        if (user != null) {
          final uid = user.uid; // Use Firebase Auth UID
          final userRef = databaseRef.child(uid); // Set the path to 'users/{uid}'
