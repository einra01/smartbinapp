...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AccountManagementPage1(),
    );
  }
}

class AccountManagementPage1 extends StatefulWidget {
  @override
  _AccountManagementPage1State createState() => _AccountManagementPage1State();
}
class _AccountManagementPage1State extends State<AccountManagementPage1> {
  ...
  void _updateName() async {
    ...
    if (user != null) {
      try {
        ...
        // Add a notification for the name change
...
// Method to add a notification for the name change
  Future<void> _addNameChangeNotification(
      String userId, String currentName, String newName) async {
    try {
      ...
      await newNotificationRef.set({
        ...
        'name': '$currentName',
        'status': 'updated their name to $newName',
        'date': formattedDate,
        'time': formattedTime,
      });
  ...
  void _showModalNotifications(String title, String message, bool isSuccess, {bool showClose = false}) {
    showDialog(
      context: context,
                        ...
                        child: Column(
                          children: [
                            TextField(
                              ...
                              textCapitalization: TextCapitalization.words, // Automatically capitalize words
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: const Text(
                                  'Save',
                                  style: TextStyle(fontSize: 18), // Increase text size for better visibility
                                ),
                              ),
                            ),
