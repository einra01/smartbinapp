...
class _DashboardScreenState extends State<uDashboardScreen> with SingleTickerProviderStateMixin {
  ...
  void _loadDevices() async {
    try {
      ...
      // 🔹 Step 2: Fetch Device Details for Each Device Key
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => uDashboardScreen1(
                                      deviceId: id, // Pass device ID
                                      deviceName: name, // Pass device name
                                      deviceStatus: status,
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      name,
                                      style: TextStyle(
                                        color: status.toLowerCase() == "error" || status.toLowerCase() == "full" ? Colors.white : Colors.black,
                                        fontSize: 12,
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ),
