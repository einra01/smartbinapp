...
// Method to filter notifications based on selected time frame
  Future<List<MapEntry<String, dynamic>>> _fetchNotifications(String userId) async {
    ...
    return allNotifications; // ✅ Now it returns a List
  }
              ...
              actions: [
                ElevatedButton(
                  onPressed: () {
                    ...
                    _fetchNotifications(userId); // ✅ Fetch notifications after applying the new date range
              ...
              builder: (context, snapshot) {
                ...
                return FutureBuilder<List<MapEntry<String, dynamic>>>(
                  ...
                  builder: (context, futureSnapshot) {
                    ...
                    // 🔥 Filter notifications based on the selected date range
...
class NotificationItem extends StatelessWidget {
  ...
  final String date; // ✅ Make sure we use this!
